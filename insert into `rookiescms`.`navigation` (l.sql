...
insert into `RookiesCMS`.`profit` (title, sub_title, languages_id, navigation_id )
  VALUES
...
insert into `RookiesCMS`.`contact_form` (fullname,company_name,email,phone_number,description,CTA_label,languages_id)
  VALUES

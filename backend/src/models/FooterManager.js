...
class FooterManager extends AbstractManager {
  ...
  findFooter(languagesId) {
    return this.connection.query(
      `select f.languages_id, f.phone_number, f.mail, f.sub_title1, f.sub_title2, f.copyright, f.terms, f.policy, f.newsletter ,i.image_link, im.image_link as image_link2, i.image_alt, im.image_alt as image_alt2, imm.image_link as image_logo_link, imm.image_alt as image_logo_alt from footer as f
